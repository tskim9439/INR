...
audio = AudioFile('/home/gtts/INR/LJ001-0001.wav')
...
#%%
output = model_output.cpu().view(-1).detach()# * scale
plt.plot(output)
plt.show()
...
plt.show()
# %%
torch.mean(torch.abs(data - output)) # tensor(0.0161)
# %%
...
# (tensor(3.6671), tensor(4.0025))
#pesq_wide(output, data), pesq_narrow(output, data)
pesq(output, data), psnr(output, data) # (1.8555114269256592, tensor(31.1707))
# %%
